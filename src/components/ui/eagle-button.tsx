  ...
  ({ className, children, ...props }, ref) => {
    return (
      <Button
        ref={ref}
        className={cn(
          "bg-[#1A9BD7] text-white shadow-[2px_2px_3px_rgba(0,0,0,0.3)] hover:bg-[#1689c1] w-48 max-w-full uppercase font-bold py-3 h-12 rainbow-enhanced",
          className
        )}
        {...props}
      >
  ...
  ({ className, children, ...props }, ref) => {
    return (
      <Button
        ...
        variant="outline"
        className={cn(
          "border-[#1A9BD7] text-white hover:bg-[#1A9BD7]/10 w-48 max-w-full shadow-[2px_2px_3px_rgba(0,0,0,0.3)] uppercase font-bold py-3 h-12",
          className
        )}
        {...props}
      >

        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-12 space-y-8">
            ...
            <ProblemItem
              ...
              detail="Costing £1,500+ per lost booking"
              delay={200}
              isVisible={animationStarted}
            />
            <ProblemItem
              number={3}
              problem="Weak Consultation Closing"
              detail="Leaving money on the table"
              delay={400}
              isVisible={animationStarted}
            />
          </div>

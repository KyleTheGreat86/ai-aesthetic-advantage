...
const steps = [
  {
    ...
    details: [
      "AI system contacts your satisfied patients via SMS",
      "Smart filtering prevents negative reviews from going public",
      "Steady stream of authentic 5-star reviews builds trust",
    ],
  ...
  },
  {
    ...
    details: [
      "AI caller responds to every enquiry within 5 minutes",
      "Books consultations 24/7, even outside office hours",
      "Never misses a potential patient again",
    ],
  ...
  {
    number: 3,
    title: "Consultation Conversion Boost",
    details: [
      "We analyse your successful consultations",
      "Create optimised scripts that overcome objections",
      "Your team closes 25-30% more treatments",
    ],

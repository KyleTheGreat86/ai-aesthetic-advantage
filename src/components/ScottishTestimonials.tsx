...
const testimonials = [
  {
    author: {
      name: "Morag Campbell",
      handle: "Director, Glasgow Premier Properties",
  ...
  },
  {
    author: {
      name: "Duncan MacLeod", 
      handle: "Owner, Highland Properties Edinburgh",
  ...
  },
  {
    author: {
      name: "Fiona Stewart",
      handle: "Managing Director, Thistle Estates", 
  ...
  },
  {
    author: {
      ...
      handle: "Senior Partner, Burns & Associates Realty",

    ...
    >
      <div className="section-container relative z-10">
        ...
        <div className="max-w-4xl mx-auto">
          <div
            className={`max-w-lg mx-auto transform transition-all duration-700 ${
              isVisible
          ...
          >
            <GlowingCard intensity="strong">
              <div className="relative bg-white/5 backdrop-blur-sm rounded-lg p-8 border border-white/10">
                ...
                <GlowingCard intensity="medium" className="mb-8">
                  <div className="bg-eagle-orange/10 border border-eagle-orange/30 rounded-lg p-4">
